...
public class AdaptadorUsuario implements IAdaptadorUsuarioDAO {
	...
	public Usuario recuperarUsuario(int codigo) {
		...
		// TODO usuario.setDescuento(descuento);
	...
	private String obtenerCodigos(List<Contacto> contactos) {
	    return contactos.stream()
	            ...
	            .collect(Collectors.joining(" ")); // Unimos los códigos con un espacio entre ellos, eficiente y buena práctica en rendimiento
	}
